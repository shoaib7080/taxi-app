    ...
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView className="px-5">
        ...
        <View className="flex-row items-center mt-2 mb-6">
          ...
          <Text className="text-xl font-bold ml-4 font-sans text-black">Book a Ride</Text>
        </View>

        {/* TRIP SUMMARY WIDGET */}
       <View className={`rounded-3xl p-5 shadow-sm border ${isSaver ? 'bg-green-50 border-green-200' : 'bg-white border-gray-100'}`}>
          ...
          <View className="flex-row items-center mb-6">
            ...
            <View className="flex-1 border-b border-gray-100 pb-4">
              ...
              <Text className="text-lg font-bold text-black mt-1">San Isidro, QC</Text>
            </View>
          </View>
          ...
          <View className="flex-row items-center">
            ...
            <View className="flex-1">
              <Text className="text-gray-400 text-xs font-sans">Destination</Text>
              <Text className="text-lg font-bold text-black mt-1">Sunny San Isidro</Text>
            </View>
          </View>
      ...
      <View className="mt-8 bg-white p-5 rounded-3xl shadow-sm border border-gray-100">
         <View className="flex-row justify-between mb-2">
            ...
            <Text className="font-bold">400 AED</Text>
         </View>
         
         {isSaver && (
             <View className="flex-row justify-between mb-2">
                <Text className="text-green-600 font-bold">Smart Return Discount</Text>
        ...
        {/* PREFERENCES SECTION */}
        <Text className="text-lg font-bold font-sans mt-8 mb-4">Preferences</Text>
        ...
        <TouchableOpacity 
            ...
            className={`${isSaver ? 'bg-green-600' : 'bg-primary'} py-4 rounded-2xl items-center shadow-lg`}
        >
                <Text className="text-white text-lg font-bold font-sans">Book Ride</Text>
            </TouchableOpacity>

            <TouchableOpacity className="bg-white py-4 rounded-2xl items-center border border-gray-200">
                <Text className="text-black text-lg font-bold font-sans">Schedule ride</Text>
            </TouchableOpacity>
        </View>
