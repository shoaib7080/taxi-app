...
interface SearchOverlayProps {
  ...
  onConfirmLocation: () => void; // Usually just closing search to confirm pinned pin
  onClose: () => void;
...
export const SearchOverlay = ({
  ...
  return (
    ...
    >
      {/* We use a SafeAreaView-like padding here for the search container */}
      <View className="bg-white/95 px-5 pt-12 pb-2 shadow-sm rounded-b-2xl">
